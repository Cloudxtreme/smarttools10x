...
/*
   ...
   along with this program.  If not, see <http://www.gnu.org/licenses/>. 
*/
#ifndef _smart_smake_Application_h
#define _smart_smake_Application_h
...
private:
   ...
   bool a_verbose;
   bool a_directVideo;
   const char* a_objectName;

   void initialize () throw (RuntimeException);
   void run () throw (RuntimeException);      
   bool execute (const std::string& _command, FILE* log, const char* vtarget) throw (RuntimeException);
   void cbs () throw (RuntimeException);
   int getKeyCode (const std::string& filename) const throw (RuntimeException);
};
