...
*/
#ifndef _smart_generate_Application_h
#define _smart_generate_Application_h
...
private:
   ...
   static bool testFineCongurator (const std::string& filename) throw (RuntimeException);
