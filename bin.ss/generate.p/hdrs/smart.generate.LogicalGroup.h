...
*/
#ifndef _smart_generate_LogicalGroup_h_
#define _smart_generate_LogicalGroup_h_
...
class LogicalGroup : public SourceContainer {
public:
   LogicalGroup () : SourceContainer (Type::LogicalGroup, false) {;}
...
private:
   ...
   void do_writeLoad (Makefile&) const throw (RuntimeException) {;}
