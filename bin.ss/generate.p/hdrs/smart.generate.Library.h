...
*/
#ifndef _smart_generate_Library_h_
#define _smart_generate_Library_h_
...
class Library : public SourceContainer {
public:
   Library () : SourceContainer (Type::Library, true) {;}
...
private:
   ...
   void do_writeILS (Makefile&) const throw (RuntimeException);
   void do_writeDirectoryOutput (Makefile& makefile) throw (RuntimeException);
