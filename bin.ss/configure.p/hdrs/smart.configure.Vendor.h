...
*/
#ifndef smart_configure_Vendor_h
#define smart_configure_Vendor_h
...
class Vendor : public Directory {
public:
   Vendor (const std::string& id) : Directory (id) {;}

   const Resource* getResource () const throw () { return (const Resource*) getPredecessor (); }
