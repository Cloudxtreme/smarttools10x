...
smart_define_sccs_tag (OnlineHelp, 0);

void smart::onlinehelp::sccs::activate ()
   throw ()
{
   smart::sccs::activate ();
   nemesis::ModuleManager::instanciate ().insert (smart_use_sccs_tag (OnlineHelp), "00");
}
